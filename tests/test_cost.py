"""Tests for _cost.py: compute_cost() for Ollama (self-hosted, always None).

Since Ollama is self-hosted, compute_cost() must always return None —
...
from amplifier_module_provider_ollama._cost import compute_cost
